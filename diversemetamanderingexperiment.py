        ...
        for chaintype in ["tree"]:
            ...
            for p in [.6]:
                ...
                for width in widths:
                    ...
                    plt.savefig("./plots/Attractor/" +  "_p_1" + str(p_1) +  "_p_2" + str(p_2) +  "Size" + str(m) + "WIDTH" + str(width) + "Bias" + str(diagonal_bias) +  "UnderlyingGraph.png" )
                    plt.close()
                    ...
                    f = open("./plots/Attractor/" +  "_p_1" + str(p_1) +  "_p_2" + str(p_2) + str(alignment) + "SAMPLES" + str(steps) + "Size" + str(m) + "chaintype" + str(chaintype) + "Bias" + str(diagonal_bias) + "P" + str(
                    ...
                    nx.draw(graph, pos={x: x for x in graph.nodes()}, node_color=[0 for x in graph.nodes()], node_size=1,
                            ...
                            cmap='magma', width=3)
                    plt.savefig("./plots/Attractor/" +  "_p_1" + str(p_1) +  "_p_2" + str(p_2) + str(alignment) + "SAMPLES" + str(steps) + "Size" + str(m) + "WIDTH" + str(width) + "chaintype" +str(chaintype) +  "Bias" + str(diagonal_bias) +  "P" + str(
                    ...
                    plt.axis('off')
                    plt.savefig("./plots/Attractor/" +  "_p_1" + str(p_1) +  "_p_2" + str(p_2) + "Size" + str(m) + "WIDTH" + str(width) + "chaintype" +str(chaintype) + "Bias" + str(diagonal_bias) + "P" + str(
