...
def viz(graph, edge_set, coloring):
    ...
    nx.draw(graph, pos=nx.get_node_attributes(graph, 'pos'), node_color = node_values, edge_color = values, labels = coloring_convert, width = 10)
...
def test():
    ...
    viz(graph, true_samples[-1][0], true_samples[-1][1])
